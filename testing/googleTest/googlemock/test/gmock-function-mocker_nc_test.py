"""Negative compilation testing for Google Mock macro MOCK_METHOD."""
...
if not IS_LINUX:
  sys.stderr.write(
      "WARNING: Negative compilation testing are not supported on this platform")
  sys.exit(0)
...
class GMockMethodNCTest(googletest.TestCase):
  """Negative compilation testing for MOCK_METHOD."""
